...
public class DatePicker2 {
	...
	private TextView time_picker_now;
	...
	public void selectDateDialog(final TextView tv_time,String defaultTime) {
		...
		dialog_time.setContentView(view, lp);
		 ...
		 time_picker_now = (TextView) view.findViewById(R.id.time_picker_now);
...
//				((TextView) tv_time).setText(str1[0]+"-"+str1[1]);
				
				((TextView) tv_time).setText(age);
				dialog_time.dismiss();
			}
		});
//		time_picker_now.setOnClickListener(new OnClickListener() {//至今
//			
//			@Override
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				((TextView) tv_time).setText("至今");
//				dialog_time.dismiss();
//			}
//		});
